...
--이전거 혹시 남아있을까 불안하다? 여기까지 다 실행하세요!
...
DROP SEQUENCE SEQ_MUSEUM CASCADE CONSTRAINTS;
DROP SEQUENCE SEQ_TEXT CASCADE CONSTRAINTS;

 */

/* 필요 시퀀스!!! 총 11개 개수 확인 완료 */
...
(
	...
	-- 2- 받을때
	dmCode number,
	dmSend date DEFAULT SYSDATE,
	dmRead date DEFAULT SYSDATE,
	PRIMARY KEY (dmNo)
);


CREATE TABLE DMCONTENT
(
	-- SEQ_DM
	dmNo number NOT NULL,
	dmContent nvarchar2(2000)
);
...
ALTER TABLE DMCONTENT
	ADD FOREIGN KEY (dmNo)
	REFERENCES DM (dmNo)
	ON DELETE CASCADE
;
