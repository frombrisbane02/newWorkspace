<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<div class="tab_cont" id="likes">
						<ul class="cont_list">
							<li class="photo_area">
								<a href="" class="photo_link">					
									<div class="img_area" style="background-image: url(<c:url value="/resources/img/feed/test_img02.jpg"/>"><img src="<c:url value="/resources/img/feed/fake02.png"/>" alt=""></div>	
									<div class="txt_area">
