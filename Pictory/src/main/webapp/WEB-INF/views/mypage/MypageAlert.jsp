								...
								<li class="media pt-3 pr-3"> 
									...
									<div class="media-body">
										...
										<c:if test = "${alarm.alarmType eq '좋아요' || alarm.alarmType eq '댓글'}">
											...
											<a href="<c:url value="/gallery/GalleryAlarm.do?postTitle=${alarm.subject}&userNo=${alarm.receiver}"/>" style="text-decoration:none;color:#A999FF"><p class="text"><i class="fa-solid fa-circle-arrow-right">&nbsp</i>${alarm.subject}</p></a>
										</c:if>
										<c:if test = "${alarm.alarmType eq '관리자'}">
