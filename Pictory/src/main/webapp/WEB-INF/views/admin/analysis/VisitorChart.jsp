                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-transparent border-0">
                                <a href="${pageContext.request.contextPath}/admin/analysis/Visit.do" class="dropdown-item">방문자 수(일/주/월)</a>
                                <a href="${pageContext.request.contextPath}/admin/analysis/Earning.do" class="dropdown-item">매출(일/주/월)</a>
                                <a href="${pageContext.request.contextPath}/admin/analysis/Member.do" class="dropdown-item">회원 수(일/주/월)</a>
                                <a href="${pageContext.request.contextPath}/admin/analysis/GalleryStory.do" class="dropdown-item">갤러리 / 스토리(일/주/월)</a>
                            </div>
                        </div>
...
<header id="introduction" class="bg-light">
    <h3 style="text-align: center; color: black;">일 / 주 / 달 방문자 수 통계</h3>
</header>
...
<label class="panel-label"
      for="panel-1-ctrl">일별 총 방문자 수</label>
</li><!--INLINE-BLOCK FIX
--><li id="li-for-panel-2">
<label class="panel-label"
      for="panel-2-ctrl">주차별 총 방문자 수</label>
</li><!--INLINE-BLOCK FIX
--><li id="li-for-panel-3">
<label class="panel-label"
      for="panel-3-ctrl">월별 총 방문자 수</label>
</li><!--INLINE-BLOCK FIX
--><!--INLINE-BLOCK FIX
-->
                ...
                <div class="table-responsive">
                    <div class="bg-light rounded p-4">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <h3 class="mb-0">일별 총 방문자 수 차트</h3>
                        </div>
                        <div id="div_visitDayChart">
                    <canvas id="visitDayChart" style="width: 100%; max: width 1104px;"></canvas>
                		</div>
                <!--일일매출차트 끝-->   
                    </div>
                        <!--일일매출표 시작-->
                    ...
                    <div class="col-sm-12 col-xl-5">
                        <div class="bg-light rounded h-100 p-4">
                            <h3 class="mb-4">현재 총 방문자 수 합계</h3>
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        <th scope="col"></th>
                                        <th scope="col">현재 방문자 수 합계</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
    ...
    <div class="bg-light  rounded p-4">
        <div class="table-responsive">
            <div class="bg-light text-center rounded p-4">
                ...
                <!--주차별 매출 차트 시작-->
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <h3 class="mb-0">주차별 총 방문자 수 차트</h3>
                </div>
                <canvas id="visitWeekChart" style="width:100%; max: width 1104px;"></canvas>
                <!--주차별 매출 차트 끝-->
            </div>
            <!--주차별 매출 표 시작-->
            <div class="col-sm-12 col-xl-10">
                <div class="bg-light rounded h-100 p-4">
                    <h3 class="mb-4">주차별 총 방문자 수 표</h3>
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th scope="col">주차</th>
    ...
    <div class="bg-light  rounded p-4">
        <div class="table-responsive">
            <div class="bg-light text-center rounded p-4">
                ...
                <!--월별 매출 차트 시작-->
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <h3 class="mb-0">월별 총 방문자 수 차트</h3>
                </div>
                <canvas id="visitMonthChart" style="width:100%; max: width 1104px;"></canvas>
                 <!--월별 매출 차트 끝-->
            </div>
            <!--월별 매출 표 시작-->
            <div class="col-sm-12 col-xl-10">
                <div class="bg-light rounded h-100 p-4">
                    <h3 class="mb-4">월별 총 방문자 수 표</h3>
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th scope="col">월별</th>
...
function aa(monthDay){
	...
	// 기존 캔버스 삭제
	 $('#visitDayChart').remove();
	// 새로 다시 그림
	 $('#div_visitDayChart').append('<canvas id="visitDayChart" style="width: 100%; max: width 1104px;"></canvas>');
	...
	$('.thID_1').append('<th scope="col">매출</th>');
	$('.thID_2').append('<th scope="col">매출</th>');
	$('.thID_3').append('<th scope="col">매출</th>');
...
//var yValues = [99, 135, 170, 130, 190, 180, 12, 34, 43, 43, 75, 323, 34, 65, 36, 135, 345,234,543,124,323,124,534,124,674,244,455,423,453,123,125];
//var barColors = [
