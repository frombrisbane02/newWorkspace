...
<header id="introduction" class="bg-light">
    <h3 style="text-align: center; color: black;">일 / 주 / 달 회원 수 통계</h3>
</header>
...
<label class="panel-label"
      for="panel-1-ctrl">일별 총 회원 수</label>
</li><!--INLINE-BLOCK FIX
--><li id="li-for-panel-2">
<label class="panel-label"
      for="panel-2-ctrl">주차별 총 회원 수</label>
</li><!--INLINE-BLOCK FIX
--><li id="li-for-panel-3">
<label class="panel-label"
      for="panel-3-ctrl">월별 총 회원 수</label>
</li><!--INLINE-BLOCK FIX
--><!--INLINE-BLOCK FIX
-->
            ...
            <div class="bg-light rounded p-4" >
                <div class="table-responsive">
                    <div class="bg-light rounded p-4">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <h3 class="mb-0">일별 총 회원 수 차트</h3>
                        </div>
                        <div id="div_memberDayChart">
                ...
                <!--일일매출차트 끝-->   
                    ...
                    <div class="col-sm-12 col-xl-5">
                        <div class="bg-light rounded h-100 p-4">
                            <h3 class="mb-4">현재 총 회원 수 합계</h3>
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        <th scope="col"></th>
                                        <th scope="col">현재 회원 수 합계</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
    ...
    <div class="bg-light  rounded p-4">
        <div class="table-responsive">
            <div class="bg-light text-center rounded p-4">
                ...
                <!--주차별 매출 차트 시작-->
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <h3 class="mb-0">주차별 총 회원 수 차트</h3>
                </div>
                <canvas id="memberWeekChart" style="width:100%; max: width 1104px;"></canvas>
                <!--주차별 매출 차트 끝-->
            </div>
            <!--주차별 매출 표 시작-->
            <div class="col-sm-12 col-xl-10">
                <div class="bg-light rounded h-100 p-4">
                    <h3 class="mb-4">주차별 총 회원 수 표</h3>
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th scope="col">주차</th>
    ...
    <div class="bg-light  rounded p-4">
        <div class="table-responsive">
            <div class="bg-light text-center rounded p-4">
                ...
                <!--월별 매출 차트 시작-->
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <h3 class="mb-0">월별 총 회원 수 차트</h3>
                </div>
                <canvas id="memberMonthChart" style="width:100%; max: width 1104px;"></canvas>
                 <!--월별 매출 차트 끝-->
            </div>
            <!--월별 매출 표 시작-->
            <div class="col-sm-12 col-xl-10">
                <div class="bg-light rounded h-100 p-4">
                    <h3 class="mb-4">월별 총 회원 수 표</h3>
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th scope="col">월별</th>
...
var yValues = [34, 46, 54, 43, 50];
var barColors = [
  
 ];

new Chart("memberWeekChart", {
	  type: "line",
	  data: {
	    labels: xValues,
	    datasets: [{
