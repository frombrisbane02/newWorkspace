...
<label class="panel-label"
      for="panel-2-ctrl">매출 수익 (회원)</label>
</li><!--INLINE-BLOCK FIX
--><li id="li-for-panel-3" class="galleryClass">
<label class="panel-label"
      for="panel-3-ctrl">매출 수익 (PICKTORY)</label>
</li><!--INLINE-BLOCK FIX
--><li id="li-for-panel-4">
<label class="panel-label"
      for="panel-4-ctrl">회원 정보</label>
</li><!--INLINE-BLOCK FIX
--><!--INLINE-BLOCK FIX
-->
            ...
            <div class="searchbox" style="margin-top:10px; margin-bottom:10px; ">
                ...
                <div class="dropdown" style="margin-left: 20px;">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="#">가입일</a>
                        <a class="dropdown-item" href="#">생년월일</a>
                        <a class="dropdown-item-text" href="#">주소</a>
                    </div>
                </div>
