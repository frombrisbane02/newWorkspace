	...
	<div class="container-s position-relative bg-white d-flex p-0">
		...
		<div class="content">
           ...
           <header id="introduction" class="bg-light">
                <h3 style="text-align: center; color: black;">최 근 구 매 / 판 매 목 록</h3>
            </header>
            <!-- Sale & Revenue Start -->
            ...
            <table class="table table-hover text-center">
                <thead>
                  <tr class="table-secondary text-center">
                      ...
                      <th class="col-2">구매/판매 목록</th>
                      <th class="col-2">구매자 아이디</th>
                      <th class="col-1">구매자 이름</th>
                      <th class="col-2">판매자 아이디</th>
                      <th class="col-1">판매자 이름</th>
                      <th class="col-1">금액</th>
                      <th class="col-2">구매/판매 일자</th>
                    </tr>
                </thead>
			...
			<c:if test="${not isEmpty }">
				<c:forEach var="record" items="${records}">
					<tr>
						<td>${record.no}</td>				
						<td class="text-left"><a href="${pageContext.request.contextPath}/admin/manager/RecentPurchase.do?no=${record.no}"/>${record.title}</a></td>
              ...
              <!-- 최근구매판매 예시 시작 -->
                  <tr>
                      ...
                      <td><a href="${pageContext.request.contextPath}/admin/manager/MemberOne.do">AKAJAKA</a></td>
                      <td class="text-center">마길동</td>
                      <td><a href="${pageContext.request.contextPath}/admin/manager/MemberOne.do">KYK</a></td>
