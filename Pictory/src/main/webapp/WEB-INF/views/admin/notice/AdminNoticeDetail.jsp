	...
	<div class="container-s position-relative bg-white d-flex p-0">
		...
		<div class="content">
           ...
           <header id="introduction" class="bg-light">
                <h3 style="text-align: center; color: black;">관 리 자 공 지 사 항 내 용</h3>
            </header>
            <!-- Sale & Revenue Start -->
            <div class="container-fluid pt-4 px-4">
                ...
                <br>
                    ...
                    <sec:csrfInput/>     
                        ...
                        <input value="공지사항입니다"  type="text" class="form-control" name="title"  >
                      </div>
                      
                      <div class="form-group">
                        <h4 style="color:#484554;">내용</h4>
                        <textarea class="form-control" rows="5" name="content">*공지사항*
신고 내역들이 많아 지고 있습니다</textarea>
                      </div>
                      <button type="submit" class="btn btn-primary"><a class="text-white" href="${pageContext.request.contextPath}/admin/notice/AdminNoticeEdit.do" class="dropdown-item">수정</a></button>&nbsp;
                      <button type="submit" class="btn btn-primary"><a class="text-white" href="${pageContext.request.contextPath}/admin/notice/AdminNotice">삭제</a></button>
                      
                      <div class="form-group">
                        <div class="comment-main-level">
                            <!-- Avatar -->
                            <br><h4 style="color:#484554;">댓글</h4>
                            <hr>
                            <div class="d-flex align-items-center border-bottom py-3">
                                <img class="rounded-circle flex-shrink-0" src="img/test_img02.jpg" alt="" style="width: 40px; height: 40px;">
                                <div class="w-100 ms-3">
                                    <div class="d-flex w-100 justify-content-between">
                                        <h6 class="comment-avatar"><a href="${pageContext.request.contextPath}/admin/manager/MemberOne.do">관리자1 아이디</a></h6>
                                        <small>12 분 전</small>
                                    </div>
                                    <span>네 확인해보겠습니다</span>
                                </div>
                            </div>
                            <hr>
                            <div class="d-flex align-items-center border-bottom py-3">
                                ...
                                <div class="w-100 ms-3">
                                    <div class="d-flex w-100 justify-content-between">
                                        <h6 class="comment-avatar"><a href="${pageContext.request.contextPath}/admin/manager/MemberOne.do">관리자2 아이디</a></h6>
                                        <small>24 분 전</small>
                                    </div>
                                    <span>네 감사합니다</span>
                                </div>
                        ...
                        <br>
                        <textarea class="form-control" rows="1" name="content">네 알겠습니다</textarea>
                      </div>
                      <br>
