	...
	<div class="container-s position-relative bg-white d-flex p-0">
		...
		<div class="content">
           ...
           <header id="introduction" class="bg-light">
                <h3 style="text-align: center; color: black;">Q & A 답 변</h3>
            </header>
            <!-- Sale & Revenue Start -->
            <div class="container-fluid pt-4 px-4">
                ...
                <br>
                    ...
                    <sec:csrfInput/>       
                      ...
                      <button type="submit" class="btn btn-primary"><a class="text-white" href="${pageContext.request.contextPath}/admin/notice/QNAList.do">답변하기</a></button>
                    </form>	
                </div>
