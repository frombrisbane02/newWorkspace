...
<body>
	<div class="container-s position-relative bg-white d-flex p-0">
		...
		<div class="content">
            ...
            <header id="introduction" class="bg-light">
                <h3 style="text-align: center; color: black;">신 고 접 수 받 습 니 다</h3>
            </header>
            ...
            <div class="searchbox" style="margin-top:10px; margin-bottom:10px; ">
                ...
                <div class="dropdown" style="margin-left: 20px;">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item"  onclick="sortTable(0)">아이디</a>
                        <a class="dropdown-item"  onclick="sortTable(1)">제목</a>
                        <a class="dropdown-item"  onclick="sortTable(2)">신고일</a>
                    </div>
                </div>
 ...
 <table class="table table-hover table-sortable">
    ...
    <tbody class="table-sm text-center">
			...
			<c:if test="${not isEmpty }">
				<c:forEach var="record" items="${records}">
					<tr>
						<td>${record.no}</td>				
						<td class="text-left"><a href="${pageContext.request.contextPath}/admin/notice/ReportDetail.do"?no=${record.no}"/>${record.title}</a></td>
						<td>${record.id}</td>
						<td>${record.name}</td>	
  ...
  <!-- 신고내역 예시 시작 -->
      <tr>
        <td>4</td>
        <td><a href="${pageContext.request.contextPath}/admin/notice/ReportDetail.do">갤러리 [5번] 신고합니다</a></td>
        <td class="text-center">kim</td>
        <td class="text-center">가길동</td>
        <td class="text-center">3</td>
        <td class="text-center">22-05-31</td>
    </tr>
    <tr>
        <td>4</td>
        <td><a href="${pageContext.request.contextPath}/admin/notice/ReportDetail.do">갤러리 [2번] 신고합니다</a></td>
        <td class="text-center">a</td>
        <td class="text-center">가길동</td>
        <td class="text-center">3</td>
        <td class="text-center">22-05-1</td>
    </tr>
    <tr>
        <td>4</td>
        <td><a href="${pageContext.request.contextPath}/admin/notice/ReportDetail.do">갤러리 [6번] 신고합니다</a></td>
        <td class="text-center">b</td>
        <td class="text-center">가길동</td>
        <td class="text-center">3</td>
        <td class="text-center">22-05-2</td>
    </tr>
    <tr>
        <td>4</td>
        <td><a href="${pageContext.request.contextPath}/admin/notice/ReportDetail.do">갤러리 [4번] 신고합니다</a></td>
        <td class="text-center">c</td>
        <td class="text-center">가길동</td>
        <td class="text-center">3</td>
        <td class="text-center">22-05-3</td>
    </tr>
    <tr>
        <td>4</td>
        <td><a href="${pageContext.request.contextPath}/admin/notice/ReportDetail.do">갤러리 [5번] 신고합니다</a></td>
        ...
        <td class="text-center">가길동</td>
        <td class="text-center">3</td>
        <td class="text-center">22-05-4</td>
    </tr>
    <tr>
        <td>4</td>
        <td><a href="${pageContext.request.contextPath}/admin/notice/ReportDetail.do">갤러리 [53번] 신고합니다</a></td>
        <td class="text-center">e</td>
        <td class="text-center">가길동</td>
        <td class="text-center">3</td>
        <td class="text-center">22-05-5</td>
    </tr>
    <tr>
        <td>4</td>
        <td><a href="${pageContext.request.contextPath}/admin/notice/ReportDetail.do">갤러리 [5번] 신고합니다</a></td>
        ...
        <td class="text-center">가길동</td>
        <td class="text-center">3</td>
        <td class="text-center">22-05-6</td>
    </tr>
    <!-- 신고내역 예시 끝 -->
