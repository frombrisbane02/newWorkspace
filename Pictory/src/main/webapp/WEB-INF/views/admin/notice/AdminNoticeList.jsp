	...
	<div class="container-s position-relative bg-white d-flex p-0">
		...
		<div class="content">
            ...
            <header id="introduction" class="bg-light">
                <h3 style="text-align: center; color: black;">관 리 자 공 지 사 항 리 스 트</h3>
            </header>
            <!-- Sale & Revenue Start -->
			...
			<!-- 예시 게시물 표현 시작-->
			                 <tr>
			                      ...
			                      <td><a href="${pageContext.request.contextPath}/admin/notice/AdminNoticeDetail.do">[공지사항] 관리자 용 공지사항입니다</a></td>
		    ...
		    <!-- 예시 게시물 표현 끝-->
              ...
              <div>
              <button class="btn btn-primary btn-sm" style="float: right;" type="button" onclick="location.href='${pageContext.request.contextPath}/admin/notice/AdminNoticeWrite.do' ">작성</button>
              </div>
            <!-- Widgets End -->
