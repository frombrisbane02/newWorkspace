	...
	<div class="container-s position-relative bg-white d-flex p-0">
		...
		<div class="content">
           ...
           <header id="introduction" class="bg-light">
                <h3 style="text-align: center; color: black;">신 고 내 용</h3>
            </header>
            <!-- Sale & Revenue Start -->
                ...
                <br>
                    <form method="post">   
                      ...
                      <div class="form-group">
                        ...
                        <input value="124번 갤러리 신고합니다"  type="text" class="form-control" name="title"  >
                      </div>

                      <div class="form-group">
                        <h4 style="color:#484554;">아이디</h4>
                        <input value="Kim"  type="text" class="form-control" name="title"  >
                      </div>
                      
                      <div class="form-group">
                        <h4 style="color:#484554;">내용</h4>
                        <textarea class="form-control" rows="5" name="content">불법적인 사행성 홍보를 하고 있습니다</textarea>
                      </div>

                      <div class="form-group">
                        <h4 style="color:#484554;">답변</h4>
                        <textarea class="form-control" rows="5" name="content">처리하였습니다</textarea>
                      </div>

                      <button type="submit" class="btn btn-primary">경고주기</button> &nbsp; <button type="submit" class="btn btn-primary">철회하기</button>
                    </form>	
                </div>
