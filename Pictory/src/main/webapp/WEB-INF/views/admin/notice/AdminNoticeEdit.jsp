	...
	<div class="container-s position-relative bg-white d-flex p-0">
		...
		<div class="content">
          ...
          <header id="introduction" class="bg-light">
                <h3 style="text-align: center; color: black;">관 리 자 공 지 사 항 수 정</h3>
            </header>
            <!-- Navbar End -->
                ...
                <br>
                    ...
                    <sec:csrfInput/>   
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="10" name="content">*공지사항*
신고 내역들이 많아 지고 있습니다</textarea>
                      </div>
                         <button type="submit" class="btn btn-primary"><a class="text-white" href="${pageContext.request.contextPath}/admin/notice/AdminNoticeList.do">등록</a></button>
                    </form>	
                </div>
