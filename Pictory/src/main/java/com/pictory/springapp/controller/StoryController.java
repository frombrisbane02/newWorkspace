...
public class StoryController {
   ...
   public String index(Model model) {
      ...
      public String virtualprocess(Model model,HttpSession req) {
...
//         System.out.println("이미지가 들어올려나???"+images.toArray().toString());
         ...
         for(StoryDTO dto:storyimages) {
            System.out.println("@@@@geturl:"+dto.getPhotoUrl());
            req.setAttribute("storyimg", dto.getPhotoUrl());
            System.out.println("!@!@req22222:"+req.getAttribute("storyimg"));
         }
   
         System.out.println("!@!@req:"+req.getAttribute("storyimg"));
   ...
   */
   ...
   public @ResponseBody String virtualrest(HttpServletRequest req) throws JsonProcessingException {
      ...
      String imgurl=(String)req.getAttribute("storyimg");
